...
public class MainMenu extends JPanel {
    ...
    public MainMenu() {
        ...
        backgroundImage = new ImageIcon("C:/Users/anton/OneDrive/Documents/GitHub/cmsc22finalproject/mainMenuScreen.png").getImage();
    ...
    private void labelClicked(String labelText) {
        ...
        switch (labelText) {
            case "Let's Go Gambling":
                ...
                JFrame mainMenuFrame = (JFrame) SwingUtilities.getWindowAncestor(gamePanel);
